...
const updateCategory = async (data,categoryId) => {
    try {
        const response = await axios.post(`${baseURL}/transactions/category/${categoryId}`, data, { headers: getAuthHeaders()})
        return response
    } catch (error) {
        return {error: error.message}
    }
...
const deleteCategory = async (categoryId) => {
    try {
        const response = await axios.post(`${baseURL}/transactions/category/${categoryId}`, { headers: getAuthHeaders()})
        return response 
    } catch (error) {
        return {error: error.message}
    }
